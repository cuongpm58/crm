            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right">
                        <a href="<%=request.getContextPath() + UrlUtil.URL_USER_ADD %>" class="btn btn-sm btn-success">Add user</a>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /row -->
                                    ...
                                    <tbody>
                                        <c:forEach var="user" items="${users}" varStatus="loop">
                                             <tr>
                                                 ...
                                                 <td>
                                                     <a href="<%=request.getContextPath() + UrlUtil.URL_USER_MODIFY %>?userId=${user.id}" class="btn btn-sm btn-primary">Sửa</a>
                                                     <a onClick="showConfirmDialog('${sessionScope.currentUser.role.name}', '${user.id}')" class="btn btn-sm btn-danger">Xóa</a>
                                                     <a href="<%=request.getContextPath() + UrlUtil.URL_USER_PROFILE %>?userId=${user.id}" class="btn btn-sm btn-info">
                                                        Xem
                                                     </a>
                                                 </td>
                                             </tr>
