            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <form class="form-horizontal form-material" action="<%=request.getContextPath() + UrlUtil.URL_TASK_MODIFY %>" method="post">
                                <input type="hidden" value="${task.jobId}" id="jobIdOfTask">
                                    ...
                                    <div class="col-md-12">
                                        <select class="form-control form-control-line" name="jobId" id="jobId">
                                             <c:forEach var="job" items="${jobs}" varStatus="loop">
                                                <option
                                                    id="job_${job.id}" value="${job.id}">${job.name}</option>
                                             </c:forEach>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" placeholder="Tên công việc" id="name" name="name" value="${task.name}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <select class="form-control form-control-line" id="statusId" name="statusId">
                                            <c:forEach var="status" items="${statuses}" varStatus="loop">
...
<script>
    $(document).ready(function () {
        ...
        {
            if(jobName === $(this).text()) {
                $("#jobId").val($(this).val())
            }
        });

        var userName = '${task.personInCharge}'
