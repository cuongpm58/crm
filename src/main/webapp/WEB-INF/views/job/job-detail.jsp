            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <ol class="breadcrumb">
                            <li><a href="<%=request.getContextPath() + UrlUtil.URL_HOME %>">Dashboard</a></li>
                            <li class="<%=request.getContextPath() + UrlUtil.URL_BLANK %>">Blank Page</li>
                        </ol>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-danger" role="progressbar"
                                            aria-valuenow="${listPercentTask[0]}" aria-valuemin="0" aria-valuemax="100" style="width: ${listPercentTask[0]}%">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-megna" role="progressbar"
                                            aria-valuenow="${listPercentTask[1]}" aria-valuemin="0" aria-valuemax="100" style="width: ${listPercentTask[1]}%">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-primary" role="progressbar"
                                            aria-valuenow="${listPercentTask[2]}" aria-valuemin="0" aria-valuemax="100" style="width: ${listPercentTask[2]}%">
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                     <c:forEach var="entry" items="${userTaskMap}" varStatus="loop">
                        <div class="col-xs-12">
                            <a href="#" class="group-title">
                                <img width="30" src="${pageContext.request.contextPath}/resources/plugins/images/users/pawandeep.jpg" class="img-circle" />
                                <span>${entry.key}</span>
                            </a>
                        </div>
                        <div class="col-md-4">
                            <div class="white-box">
                                ...
                                <div class="message-center">
                                    <c:forEach var="task" items="${entry.value[0]}" varStatus="loop">
                                        <a href="#">
                                            <div class="mail-contnet">
                                                <h5>${task.personInCharge}</h5> <span class="mail-desc">${task.name}</span> <span
                                                    class="time">${task.startTime}</span>
                                            </div>
                                        </a>
                                    </c:forEach>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="white-box">
                                ...
                                <div class="message-center">
                                    <c:forEach var="task" items="${entry.value[1]}" varStatus="loop">
                                        <a href="#">
                                            <div class="mail-contnet">
                                                <h5>${task.personInCharge}</h5> <span class="mail-desc">${task.name}</span> <span
                                                    class="time">${task.startTime}</span>
                        ...
                        <div class="col-md-4">
                            <div class="white-box">
                                ...
                                <div class="message-center">
                                    <c:forEach var="task" items="${entry.value[2]}" varStatus="loop">
                                        <a href="#">
                                            <div class="mail-contnet">
                                                <h5>${task.personInCharge}</h5> <span class="mail-desc">${task.name}</span> <span
                                                    class="time">${task.startTime}</span>
